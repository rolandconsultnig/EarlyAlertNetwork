...
/**
 * cPanel startup script for IPCR Early Warning & Response System with MySQL support
 * 
...
console.log('Starting IPCR Early Warning & Response System (MySQL version)...');
console.log(`Application root: ${appRoot}`);
console.log(`Port: ${port}`);
console.log(`Environment: ${process.env.NODE_ENV || 'development'}`);

// Start the application with our MySQL server implementation
const app = spawn('node', [path.join(appRoot, 'server-mysql.js')], {
  stdio: 'inherit',
  env: process.env
});
